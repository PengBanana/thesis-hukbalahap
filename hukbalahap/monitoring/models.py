...
class MaintenanceSchedule(models.Model):
	...
	est_chlorine = models.DecimalField(max_digits=8, decimal_places=2, default=None)
	...
	act_chlorine = models.DecimalField(max_digits=8, decimal_places=2, default=None)
