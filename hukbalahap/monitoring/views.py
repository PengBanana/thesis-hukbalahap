...
def insert_to_temp_pH():
    ...
    Temp_Ph.objects.create(pool_id=assignedPoolID, temp_phlevel=phValue, temp_phdatetime=current_timezone.localize(datetime.datetime.now()))
    print("Temp_Ph Value Added: Enrique Razon Building, " + str(phValue) + ", " + str(current_timezone.localize(datetime.datetime.now())))
...
def batchCount10pH():
    ...
    if(tempCount>0):
        ...
        print("yah")
        Final_Ph.objects.create(pool_id=assignedPoolID, final_phlevel=pHStandardDev, final_phdatetime=current_timezone.localize(datetime.datetime.now()))
        print("Final_Ph Value Added: Enrique Razon Building, " + str(pHStandardDev) + ", " + str(current_timezone.localize(datetime.datetime.now())))
        ##new notification
...
def insert_to_temp_turbidity():
    ...
    Temp_Turbidity.objects.create(pool_id=assignedPoolID, temp_turbiditylevel=turbValue, temp_turbiditydatetime=current_timezone.localize(datetime.datetime.now()))
    print("Temp_Turbidity Value Added: Enrique Razon Building, " + str(turbValue) + ", " + str(current_timezone.localize(datetime.datetime.now())))
...
def batchCount10Turbidity():
    ...
    if(tempCount>0):
        ...
        Final_Turbidity.objects.create(pool_id=assignedPoolID, final_turbiditylevel=turbidityStandardDev, final_turbiditydatetime=current_timezone.localize(datetime.datetime.now()))
        print("Final_Turbidity Value Added: Enrique Razon Building, " + str(turbidityStandardDev) + ", " + str(current_timezone.localize(datetime.datetime.now())))
...
def insert_to_temp_temperature():
    ...
    tempData = read()
    Temp_Temperature.objects.create(pool_id=assignedPoolID, temp_temperaturelevel=tempData, temp_temperaturedatetime=current_timezone.localize(datetime.datetime.now()))
    print("Temp_Temperature Value Added: Enrique Razon Building, " + str(tempData) + ", " + str(current_timezone.localize(datetime.datetime.now())))
...
def personnelEfficiency(request):
    ...
    try:
        ...
        today=datetime.date.today()
        month=today.month
        monthToDisplay=datetime.datetime.strptime(str(month), '%m').strftime('%B')
        year=today.year
